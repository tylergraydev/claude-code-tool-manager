	...
	<div class="max-w-6xl space-y-8">
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
			...
			<section class="lg:col-span-2">
				<h2 class="text-sm font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-3">Quick Actions</h2>
			...
			<section>
				<h2 class="text-sm font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500 mb-3">Global Config</h2>
				<div class="space-y-2">
